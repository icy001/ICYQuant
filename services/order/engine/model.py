"""Order engine domain services (Commit 33 Part 1.1).
...
class OrderRepository(Protocol):
    ...
    decisions.  Concrete adapters (PostgreSQL / Redis / Event Store) are added
    in later parts without touching the domain.
    """
