"""Workflow definition model — immutable workflow descriptor."""
...
from .edge import EdgeDefinition
...
class WorkflowDefinition:
    ...
    Represents a complete workflow with nodes, edges, transitions,
    ...
    def exit_nodes(self) -> List[NodeDefinition]:
        """Return nodes with no outgoing edges (exit points)."""
