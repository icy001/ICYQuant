...
and resolving configuration platform components.
...
class DIContainer:
    ...
    Manages singleton instances of configuration
    ...
    Usage:
        ...
        container.register_singleton(EnvironmentManager)

        # Register with factory
        container.register_factory(DatabaseClient, create_db_client)
...
def create_default_container() -> DIContainer:
    """
    Create a DI container with default registrations.
    ...
    container.register_singleton(ConfigurationManager)
    container.register_singleton(EnvironmentManager)
    container.register_singleton(DynamicConfigurationManager)
