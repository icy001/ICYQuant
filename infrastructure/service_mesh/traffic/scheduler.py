"""Traffic scheduler for ICYQuant Service Mesh.

Provides ``TrafficScheduler`` for background tasks including policy
sync, traffic refresh, outlier scanning, metrics flush, and
