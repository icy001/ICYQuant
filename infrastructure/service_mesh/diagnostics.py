"""Diagnostics for the Service Mesh.

Provides ``MeshDiagnostics`` for runtime diagnostics, issue
detection, and mesh status reporting.
"""
...
class MeshDiagnostics:
    """Runtime diagnostics for the service mesh."""
    ...
    def clear_issues(self, before: Optional[float] = None) -> int:
        """Clear diagnostic issues, optionally before a timestamp."""
        with self._lock:
            if before is None:
